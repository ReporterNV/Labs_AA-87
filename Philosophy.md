...
Гносеология - это философское направление, которое занимается изучением познания
...
Методы: 
1) Эмперический: наблюдение, измерение, описание, сравнения и эксперементы
2) Теоретические: метод анализа, дедукция, индукция, синтез(обратно разбору, те анализу), идеализация

Специфика научного знания - всеобщность, системность, доказуемость, проверяемость.

Законы формальной логики:
1) Принцип тождества - нельзя говорить одно и тоже о разном(не подменять понятия)
2) Закон не противоречия - нельзя говорить разное про одно и то же
3) Исключение третьего - либо да, либо нет. 3его не дано
>
>Принципы диалектической логики: 
>1) Принцип развития - любое явление/факт нужно рассматривать с учётом его развития
>2) Принцип всёобщей связи и взаимообусловлености - ничего отдельно не существует и на всё оказывается влияние другими объектами
>3) Принцип Августина

Истина - адекватное отражение свойств объекта субъектами.(неопровержимое знание)

Коресподентская истина - то что существует в реальности, то и существует

Когерентная истина - то, что не вызывает противоречия с реальностью.

Конвесциональная истина - группа людей приходит к определенному мнению.
